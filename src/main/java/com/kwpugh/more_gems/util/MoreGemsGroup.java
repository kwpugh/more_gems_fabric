...
public class MoreGemsGroup
{
    ...
    private static final ItemGroup MORE_GEMS_GROUP = FabricItemGroup.builder(new Identifier(MoreGems.MOD_ID, "more_gems_group"))
            .icon(() -> new ItemStack(ItemInit.ALEXANDRITE))
