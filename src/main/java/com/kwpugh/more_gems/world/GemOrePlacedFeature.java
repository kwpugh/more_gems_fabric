...
public class GemOrePlacedFeature
{
    ...
    // OVERWORLD ORES
    public static final PlacedFeature ORE_CITRINE_OVERWORLD = GemOreConfiguredFeature.ORE_CITRINE_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.citrinePerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.citrineMaxLevel))));
    public static final PlacedFeature ORE_TOURMALINE_OVERWORLD = GemOreConfiguredFeature.ORE_TOURMALINE_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.tourmalinePerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.tourmalineMaxLevel))));
    public static final PlacedFeature ORE_KUNZITE_OVERWORLD = GemOreConfiguredFeature.ORE_KUNZITE_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.kunzitePerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.kunziteMaxLevel))));
    public static final PlacedFeature ORE_TOPAZ_OVERWORLD = GemOreConfiguredFeature.ORE_TOPAZ_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.topazPerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.topazMaxLevel))));
    public static final PlacedFeature ORE_ALEXANDRITE_OVERWORLD = GemOreConfiguredFeature.ORE_ALEXANDRITE_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.alexandritePerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.alexandriteMaxLevel))));
    public static final PlacedFeature ORE_CORUNDUM_OVERWORLD = GemOreConfiguredFeature.ORE_CORUNDUM_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.corundumPerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.corundumMaxLevel))));
    public static final PlacedFeature ORE_SAPPHIRE_OVERWORLD = GemOreConfiguredFeature.ORE_SAPPHIRE_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.sapphirePerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.sapphireMaxLevel))));
    ...
    public static final PlacedFeature ORE_RUBY_OVERWORLD = GemOreConfiguredFeature.ORE_RUBY_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.rubyPerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.rubyMaxLevel))));
    ...
    public static final PlacedFeature ORE_CARBONADO_OVERWORLD = GemOreConfiguredFeature.ORE_CARBONADO_OVERWORLD.withPlacement(modifiersWithCount(CONFIG.carbonadoPerChunk, HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0),YOffset.fixed(CONFIG.carbonadoMaxLevel))));
